...
class myLSTM:
    ...
    # 获取数据
file_path = r'C://Users/hechuan/Desktop/SLSTM-master/results-20170508-103637.csv'
dict_size = 8000
...
# input_val_arr = [np.random.rand(3,x_dim) for _ in y_list]
# # print(input_val_arr)
# y_list = np.array(y_list)
# input_val_arr = np.array(input_val_arr)
# 训练LSTM
lstm = myLSTM(dict_size, hidden_dim=100)
lstm.train(X_train[:50], y_train[:50],
              learning_rate=0.005,
              n_epoch=3)
